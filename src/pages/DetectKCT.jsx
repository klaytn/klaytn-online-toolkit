...
import { Button, Card, CardHeader, CardBody, Row, Col } from 'components'
...
class DetectKCT extends Component {
  ...
  render() {
    const { contractAddress, result } = this.state
    return (
      <Column>
        <Card>
          <CardHeader>
            ...
            <p style={{ color: '#6c757d' }}>
              ...
              technical specifications. You can check which KCT the smart
          ...
          <CardBody>
            ...
            {KIPLinks.hasOwnProperty(result) ? (
              <p style={{ fontSize: '15px' }}>
                ...
                <a href={KIPLinks[result]}>{result} Token Standard</a>.
              </p>
            ) : result !== '' ? (
