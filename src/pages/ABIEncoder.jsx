            ...
            <CardBody>
              ...
              <Row>
                <Col md="12">
                  ...
                  <p style={{ color: '#6c757d' }}>
                    Enter the space-separated values to match the number of
                    types indicated above, using square brackets [] to wrap
                    arrays.<br></br>
                  </p>
                  <textarea
                    className="form-control"
              ...
              <Row>
                <Col md="4">
                  <Button onClick={(e) => this.encodeABI(e)}>ENCODE</Button>
                </Col>
              </Row>
              {result !== '' ? (
                result !==
                '[ERROR] PLEASE USE THE CORRECT FORMAT OF INPUTS!' ? (
                  <Row>
                    <Col md="12">
                      <Label>Result</Label>
                      <textarea
