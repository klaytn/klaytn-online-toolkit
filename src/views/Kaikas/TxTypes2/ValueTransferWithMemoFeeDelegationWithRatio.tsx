...
const ValueTransferWithMemoFeeDelegationWithRatio = ({
  walletProps,
  ...
  return (
    <>
      <CardSection>
        <h4>Value Transfer with Memo (Fee Delegation with Ratio)</h4>
...
export default ValueTransferWithMemoFeeDelegationWithRatio
