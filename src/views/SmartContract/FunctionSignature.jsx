...
class FunctionSignature extends Component {
  ...
  render() {
    const { input, result, isInputTypeSelected, inputTypes, examples } =
      this.state
    return (
      <div>
        <Column>
          <Card>
            <CardHeader>
              ...
              <p style={{ color: '#6c757d' }}>
                Encodes the function signature to its ABI signature, which are
                the first 4 bytes of the sha3 hash of the function name
              ...
              <Row>
                <Col md="12">
                  ...
                  <textarea
                    ...
                    placeholder={
                      isInputTypeSelected[0] ? examples[0] : examples[1]
                    }
                    style={{
                      height: '120px',
