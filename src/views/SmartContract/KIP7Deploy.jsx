...
class KIP7Deploy extends Component {
  ...
  deploy = async (e) => {
    const { senderAddress, tokenName, tokenSymbol, decimal, initialSupply } =
      this.state
    try {
      if (senderAddress === '') {
        ...
        <Card>
          <CardHeader>
            ...
            <p style={{ color: '#6c757d' }}>
              ...
              <a href="https://docs.klaytn.foundation/dapp/sdk/caver-js/api-references/caver.kct/kip7#caver-klay-kip7-deploy">
                {' '}
                caver.kct.kip7.deploy
              </a>{' '}
              function is used to deploy a KIP-7 token contract. After
              successful deployment, you can find contract account in explorer.
            </p>
          </CardHeader>
          <CardBody>
            ...
            {deployMsgVisible && (
              <Row>
                <Col md="8">
                  ...
                  {deployMsg !== '' && contractAddress !== '' && (
                    <CardText>
                      {deployMsg} Deployed token info can be found here:{' '}
                      <a
                        href={
                          networkLinks[network]['finderToken'] + contractAddress
                        }
                      >
                        {contractAddress}
                      </a>
