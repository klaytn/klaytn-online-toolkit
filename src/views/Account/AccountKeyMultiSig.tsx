...
import Caver, { EncryptedKeystoreV4Json, TransactionReceipt } from 'caver-js'
...
import useGetKeySection from 'views/Account/components/useGetKeySection'
...
const AccountKeyMultiSig = (): ReactElement => {
  ...
  const useGetKeySectionReturn = useGetKeySection({ caver })
  const { privateKey, keyring } = useGetKeySectionReturn
