...
const INPUT_ERROR_MSG =
  '[ERROR] PLEASE ENTER THE CORRECT VALUE OF TRANSACTION HASH!'
    ...
    try {
      ...
      if (res) {
        this.setState({
          ...
          rawResult: res.getRawTransaction(),
        })
      } else {
          ...
          <Card>
            <CardHeader>
              ...
              <p style={{ color: '#6c757d' }}>
                On this page, you can query a transaction by transaction hash
                from the Klaytn network to get a caver transaction instance.
              </p>
              <Row>
                <Col md="4">
                  <select
            ...
            <CardBody>
              ...
              <Row>
                <Col md="4">
                  <Button onClick={(e) => this.decodeTxHash()}>DECODE</Button>
                </Col>
              </Row>
