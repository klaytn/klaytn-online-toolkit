...
class SendSmartContractExecutionTx extends Component {
  ...
  walletUpdate() {
    ...
    if (!!senderKeystoreJSON) {
      const senderKeyring = caver.wallet.keyring.decrypt(
        senderKeystoreJSON,
        senderKeystorePassword
      )
  ...
  onSendTxButtonClick = async (e) => {
    try {
      ...
      const smartContractExecutionTx =
      ...
      const signed = await caver.wallet.sign(
        senderAddress,
        smartContractExecutionTx
      )
      ...
      <Column>
        <Card>
          ...
          <CardBody>
            ...
            <p style={{ color: '#6c757d' }}>
              Encodes a function call using its JSON interface object and given
              parameters.
            </p>
            <Row>
              <Col md="8">
            ...
            <Row>
              <Col md="8">
                <Button onClick={(e) => this.encodeFunctionCall(e)}>
                  Encode
                </Button>
              </Col>
            </Row>
        ...
        <Card>
          <CardHeader>
            ...
            <p style={{ color: '#6c757d' }}>
              Upload keystore file that is going to be updated. This account
              will be used for sending a Smart Contract Execution transaction to
              call the function, so it must possess sufficient KLAY.
            </p>
          </CardHeader>
          <CardBody>
            <Row>
        ...
        <Card>
          <CardHeader>
            ...
            <p style={{ color: '#6c757d' }}>
              Select Mainnet or Testnet. Enter contract address(token address),
              and gas that will be used.
            </p>
          </CardHeader>
          <CardBody>
            <Row>
