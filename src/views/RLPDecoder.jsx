...
const INPUT_ERROR_MSG =
  '[ERROR] PLEASE ENTER THE CORRECT VALUE OF RLP-ENCODED STRING!'
          ...
          <Card>
            <CardHeader>
              ...
              <p style={{ color: '#6c757d' }}>
                You can get the transaction by decoding the RLP-encoded
                transaction string.
              </p>
            </CardHeader>
            <CardBody>
              ...
              <Row>
                <Col md="4">
                  <Button onClick={(e) => this.rlpDecode()}>DECODE</Button>
                </Col>
              </Row>
